...
private static CategoryDataset createDataset(){
	...
	localDefaultCategoryDataset.addValue(Main.participate,"Total Participation User Predicted","Total Participation User Predicted");
	localDefaultCategoryDataset.addValue(Main.non_participate,"Total Non-Participation User Predicted","Total Non-Participation User Predicted");	
...
private static JFreeChart createChart(CategoryDataset paramCategoryDataset){
	JFreeChart localJFreeChart = ChartFactory.createBarChart(title,"Prediction Type", "Count", paramCategoryDataset, PlotOrientation.VERTICAL, true, true, false);
